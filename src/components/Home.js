            ...
            <div className="opening">
                <div className="flex-container">
                    <div className="flex-item-left">
                            ...
                            <p>Virtual Learn adalah platform pendidikan digital yang memberikan akses mudah dan fleksibel kepada pelajar untuk meningkatkan pengetahuan, keterampilan, dan kemampuan mereka. Melalui kursus-kursus interaktif dan berkualitas tinggi, kami menghubungkan instruktur ahli dengan para siswa dari berbagai latar belakang di seluruh Indonesia.</p>
                    </div>
